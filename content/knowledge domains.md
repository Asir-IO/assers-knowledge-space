...
<!-- QueryToSerialize: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" FROM #domain/cs-theory where !draft SORT date DESC-->
<!-- SerializedQuery: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" FROM #domain/cs-theory where !draft SORT date DESC -->

| Thumbnail                                                                                                                                                                                  | Note                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| ![[BFS and DFS 2026-03-31 19.11.51.excalidraw.svg\|BFS and DFS 2026-03-31 19.11.51.excalidraw.svg\|120]]                                                                         | [[Breadth First Search]]                         |
| ![[Drawing a Complete Tree Quickly 2026-03-30 20.25.27.excalidraw.svg\|Drawing a Complete Tree Quickly 2026-03-30 20.25.27.excalidraw.svg\|120]]                                 | [[Drawing a Complete Tree]]                 |
...
<!-- QueryToSerialize: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" FROM #domain/systems where !draft SORT date DESC -->
<!-- SerializedQuery: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" FROM #domain/systems where !draft SORT date DESC -->

| Thumbnail                                                                                                                                                                                        | Note                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                                                          | [[EER to Relational Schema Mapping]]                   |
...
<!-- QueryToSerialize: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" from #domain/ai where !draft SORT date DESC-->
<!-- SerializedQuery: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" from #domain/ai where !draft SORT date DESC -->

| Thumbnail                                                                                                                                                            | Note                                                                                                       |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Uniform Cost Search]]                                                   |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[A-Star Search]]                                                               |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Agent Architectures]]                                                   |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Minimax Algorithm]]                                                       |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Autoencoders]]                                                                 |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Meta-Heuristic Search]]                                               |
...
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Supervised Project Report]]                                           |
| ![[Axis and Aggregation 2026-04-21 19.08.20.excalidraw.svg\|Axis and Aggregation 2026-04-21 19.08.20.excalidraw.svg\|120]]                                 | [[Axes and Aggregation in Numpy]]                                   |
...
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Task Environment of an Agent]]                                 |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                              | [[Rationality of an Agent]]                                           |
...
| ![[Neural Network Diagram 2026-01-25 19.23.44.excalidraw.svg\|Neural Network Diagram 2026-01-25 19.23.44.excalidraw.svg\|120]]                             | [[Concepts/Neural Networks/index.md\|Neural Networks]]                                                     |
...
<!-- QueryToSerialize: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" from #domain/maths where !draft SORT date DESC-->
<!-- SerializedQuery: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" from #domain/maths where !draft SORT date DESC -->
...
<!-- QueryToSerialize: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" WHERE econtains(file.etags, "#domain/") AND !draft SORT date DESC-->
<!-- SerializedQuery: TABLE WITHOUT ID choice(thumbnail, "!" + replace(string(thumbnail), "]]", "|120]]"), "![[lab-temp-thumb.excalidraw.svg|120]]") AS "Thumbnail", link(file.path, title) AS "Note" WHERE econtains(file.etags, "#domain/") AND !draft SORT date DESC -->

| Thumbnail                                                                                                                                                                | Note                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| ![[How to Read an Article 2026-05-12 15.53.32.excalidraw.svg\|How to Read an Article 2026-05-12 15.53.32.excalidraw.svg\|120]]                                 | [[How to Read an Article]]                                  |
| ![[lab-temp-thumb.excalidraw.svg\|120]]                                                                                                                                  | [[Cool Visualizations I found]]                             |
