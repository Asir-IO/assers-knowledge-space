...
related-notes:
---
I just came across this website: [Explorable Explanations](https://explorabl.es/).
- I love that smth like this exists and this will definitely inspire me to create better visualizations =)

This website is a journal that also contains invaluable ML visualizations: [Distill — Latest articles about machine learning](https://distill.pub/)
